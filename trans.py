...
class AudioTranscriptionBot:
    ...
    def get_messages(self) -> str:
        ...
        response = session.get(
            "https://api.infoverse.com.br/v1/Bot_adm/file_transcription/1",
            headers=headers,
        )
        print(response.json())
        # escrenvendo json em arquivvo.txt
    ...
    def send_text(self, text: str, id_message: str):
        ...
        session = requests.Session()
        payload = {"transcrition_text": text, "id": id_message}

        response = session.post(
            "https://api.infoverse.com.br/v1/Bot_adm/file_transcription",
            headers=headers,
